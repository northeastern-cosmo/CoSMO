...
const Community = ({callbacks}) => {
    ...
    return (
        <SectionContainer callbacks={callbacks}>
            <TitleContainer>
                <Name ref={ref}>Something Something Community</Name>
                <InfoContainer>
                    <InfoSection>CoSMO creates an environment where students can meet other students interested in Computer Science. Having a network of people to reach out to who have gone through or are going through similar things (such as applying to co-ops, taking the same classes) and creating that community is something many have found beneficial in their early years and beyond!</InfoSection>
                    <InfoSection>CoSMO plans events where students are able to meet other students and start to make those connections, or at the very least learn about different viewpoints and aspects of computer science from their peers.</InfoSection>
                </InfoContainer>
            </TitleContainer>
        </SectionContainer>
    )
